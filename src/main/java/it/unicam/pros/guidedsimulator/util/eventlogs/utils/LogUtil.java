...
import it.unicam.pros.guidedsimulator.util.eventlogs.trace.event.ActivityState;
import it.unicam.pros.guidedsimulator.util.eventlogs.trace.event.MsgType;
