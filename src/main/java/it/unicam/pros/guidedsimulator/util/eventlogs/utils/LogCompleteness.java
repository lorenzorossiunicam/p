...
import static it.unicam.pros.guidedsimulator.evaluator.purpose.rediscoverability.metrics.AlphaRelations.*;

public class LogCompleteness {

    public static double measureCompleteness(XLog log, Map<String, Map<String, Relations>> relations){
    ...
    private static double checkRel(String act1, String act2, Relations rel, XLog log) {
        ...
        if(rel.equals(Relations.SEQUENCE) && seq && !pred) return 1;
        if(rel.equals(Relations.PARALLEL) && seq && pred) return 1;
        if((rel.equals(Relations.CHOICE)||rel.equals(Relations.NONE)) && !seq && !pred) return 1;
    ...
    public static void main(String[] args){
        ...
        Map<String, Map<String, Relations>> relations = getAlphaRelations((Process) mi.getModelElementById(process));
