...
public class BPMNWhatIfAnalysisWithTime implements Evaluator {
    ...
    public BPMNWhatIfAnalysisWithTime(BpmnModelInstance mi, Map<String, Double> xorAndOrProbabilities, Map<String, Double> actCosts, Map<String, Double> actDur, double maxTraces){
