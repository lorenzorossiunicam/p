...
//import it.unicam.pros.guidedsimulator.gui.util.Constants;
//import it.unicam.pros.guidedsimulator.gui.ui.view.menu.MainMenuView;
...
//        rootLogger.addHandler(new SimLogAppender());
//
//        H1 logo = new H1(Constants.toolName);
//        logo.addClassName("logo");
//        final String resolvedImage = VaadinService.getCurrent().resolveResource(
//                "images/pplgLogo.png", VaadinSession.getCurrent().getBrowser());
//
//        final Image image = new Image(resolvedImage, logo.getText());
//        image.setMaxHeight("150px");
//        image.setMaxWidth("150px");
//        HorizontalLayout header = new HorizontalLayout(image, new MainMenuView());
//
...
import it.unicam.pros.pplg.gui.ui.components.navigation.bar.AppBar;
import it.unicam.pros.pplg.gui.ui.components.navigation.bar.TabBar;
import it.unicam.pros.pplg.gui.ui.components.navigation.drawer.NaviDrawer;
import it.unicam.pros.pplg.gui.ui.components.navigation.drawer.NaviItem;
import it.unicam.pros.pplg.gui.ui.components.navigation.drawer.NaviMenu;
import it.unicam.pros.pplg.gui.ui.util.UIUtils;
import it.unicam.pros.pplg.gui.ui.util.css.FlexDirection;
import it.unicam.pros.pplg.gui.ui.util.css.Overflow;
import it.unicam.pros.pplg.gui.ui.view.rediscoverability.BPMNRediscoverabilityView;
import it.unicam.pros.pplg.gui.ui.view.whatif.BPMNWhatIfAnalysisView;
...
@CssImport(value = "./styles/components/console.css")
