package it.unicam.pros.pplg.semanticengine.bpmn.semantics;
...
import it.unicam.pros.pplg.semanticengine.bpmn.elements.IntReceiveTask;
import it.unicam.pros.pplg.semanticengine.bpmn.elements.IntSendTask;
import it.unicam.pros.pplg.semanticengine.bpmn.elements.IntTask;
...
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.EndEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.EventBasedGatewayBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.ExclusiveGatewayJoinBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.ExclusiveGatewaySplitBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.IntermediateCatchEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.IntermediateThrowEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MIIntReceiveTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MIIntSendTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MIIntTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MIPTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MISTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MessageEndEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.MessageStartEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.NAReceiveTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.NASendTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.NATaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.ParallelGatewayJoinBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.ParallelGatewaySplitBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.ReceiveTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.SendTaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.StartEventBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.TaskBehaviour;
import it.unicam.pros.pplg.semanticengine.bpmn.semantics.behaviours.mida.TerminateEndEventBehaviour;
