	...
	private class AbstractionStep extends myStep implements ActionListener {
		...
		private void initComponents() {
			double size[][] = { { 54, TableLayoutConstants.FILL },
					{ 50, 30, 20, 20, 20, 20, 30, 20, 20, TableLayoutConstants.FILL } };
			setLayout(new TableLayout(size));
			...
			add(SlickerFactory.instance().createLabel("<html><h3>Select collection size limit</h2>"), "0, 6, 1, 6");
		...
		private javax.swing.JRadioButton useFixedLengthSet;
...
//			add(improveDiamondCheckBox, "0, 2");
			add(mergeInflowCheckBox, "0, 2");
			add(mergeOutflowCheckBox, "0, 3");
...
//		private javax.swing.JCheckBox improveDiamondCheckBox;
		...
		public void readSettings() {
			...
			settings.getConverterSettings().setUse(TSConversions.EXTEND, false);
