...
@Plugin(
		name = "Mine a Process Tree with ETMd",
			parameterLabels = { "Event log", "ETM Parameters", "Seed Trees" },
			returnLabels = { "Process Tree" },
			returnTypes = { ProcessTree.class },
			userAccessible = true,
			help = "Mine a Process Tree with the ETM",
			handlesCancel = true,
...
public class ETMPlugin {
	...
	@UITopiaVariant(
			uiLabel = "Mine a Process Tree with ETMd",
	...
	@UITopiaVariant(
			uiLabel = "Mine a Process Tree with ETMr",
				affiliation = "Eindhoven University of Technology",
				author = "J.C.A.M.Buijs",
				email = "j.c.a.m.buijs@tue.nl",
				pack = "EvolutionaryTreeMiner")
