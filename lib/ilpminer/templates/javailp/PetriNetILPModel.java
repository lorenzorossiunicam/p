 ...
 * 
 */
@ILPMinerStrategy(author = "T. van der Wiel", description = "Constructs a Petri Net with the selected search strategy.", name = "Petri Net")
public class PetriNetILPModel extends ILPModelJavaILP {
	...
	public PetriNetILPModel(Class<?>[] extensions, Map<SolverSetting, Object> solverSettings, ILPModelSettings settings) {
	...
	public static Object[] getSettingsGUI(SlickerFactory f, Class<?> strategy) {
		...
		searchTypeBox = new JComboBox( 
			new SearchType[] { SearchType.BASIC, SearchType.PER_CD,
