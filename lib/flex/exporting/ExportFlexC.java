 ...
 *
 */
@Plugin(name = "Export as Flexible Model extended with cancelation region (.flexc)", returnLabels = {}, returnTypes = {}, parameterLabels = { "Flexible Model", "File" }, userAccessible = true)
@UIExportPlugin(description = "Export as Flexible Model extended with cancelation region (.flexc)", extension = "flexc")
public class ExportFlexC {
	@PluginVariant(variantLabel = "Export as Flexible Model extended with cancelation region (.flexc)", requiredParameterLabels = { 0, 1 })
	public void exportFlex(UIPluginContext context, Flex net, File file) throws IOException {
		exportFlex2File(context, net, file);
	}

	private void exportFlex2File(UIPluginContext context, Flex net, File file) throws IOException {
