...
@Plugin(name = "Open Flexible model file", parameterLabels = { "Filename" }, returnLabels = { "Flexible model",
		"Start task node", "End task node" }, returnTypes = { Flex.class, StartTaskNodesSet.class,
		EndTaskNodesSet.class })
@UIImportPlugin(description = "Flexible model files", extensions = { "flex" })
public class ImportFlex extends AbstractImportPlugin {

	protected Object importFromStream(PluginContext context, InputStream input, String filename, long fileSizeInBytes)
			throws Exception {
		context.log("Flex import started.");
