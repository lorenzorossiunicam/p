...
/**
 * @author aadrians Jun 4, 2012
 * 
 */
public class CaseFilterPanelPerf<N extends Manifest, C extends IPerfCounter<N>> extends JPanel {
	...
	public CaseFilterPanelPerf(final ManifestPerfPanel<N,C> mainPanel, List<String> caseLabels, final boolean[] caseReliability,
