 ...
 *
 */
public class PIPManifestPanel<N extends Manifest, C extends IPerfCounter<N>> extends JPanel implements MouseListener, MouseMotionListener {
	...
	private final ManifestPerfPanel<N, C> view;
	
	public PIPManifestPanel(ManifestPerfPanel<N,C> view) {
