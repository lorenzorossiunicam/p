...
import org.processmining.plugins.fuzzymodel.miner.replay.DetailNodeAnalysis;
import org.processmining.plugins.fuzzymodel.miner.replay.DetailNodeAnalysis.SimplificationType;
...
public class DetailEventView extends JComponent {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6104488753630552907L;
	...
	protected void paintComponent(Graphics g) {
		...
		String eventName = FMLog.getConceptName(analysis.getEvent());
		String eventType = FMLog.getLifecycleTransition(analysis.getEvent());
		
		String event = eventName + " (" + eventType + ")";
