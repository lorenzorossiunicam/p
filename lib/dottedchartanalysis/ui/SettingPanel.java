...
public class SettingPanel extends JPanel {
	...
	private final DottedChartAnalysis dottedChartAnalysis;
	...
	private final JButton randomizeColorButton = new JButton();
		...
		for (Iterator<String> itr = keySet.iterator(); itr.hasNext();) {
			...
			tempButton[i].addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Color newColor = JColorChooser.showDialog(tempButton, "Choose Background Color", tempButton
							.getBackground());
					if (newColor != null) {
	...
	private void randomizeColor(ActionEvent e) {
		ArrayList<String> keySet = dcModel.getItemArrayList(dottedChartAnalysis.getDottedChartOptionPanel()
				.getColorStandard());
