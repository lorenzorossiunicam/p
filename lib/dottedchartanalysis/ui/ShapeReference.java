 ...
 * 
 * Author: Minseok Song (c) 2005 Technische Universiteit Eindhoven, Minseok Song
 * all rights reserved
 * 
...
public class ShapeReference {
	...
	public static String[] shapeList = new String[] { ITEM_HANDLE_CIRCLE, ITEM_HANDLE_TRIANGLE, ITEM_HANDLE_BOX,
			ITEM_HANDLE_RHOMBUS, ITEM_HANDLE_ROUND_BOX, ITEM_HANDLE_DRAW_CIRCLE, ITEM_HANDLE_DRAW_TRIANGLE,
			ITEM_HANDLE_DRAW_BOX, ITEM_HANDLE_DRAW_ROUND_BOX, ITEM_HANDLE_DRAW_RHOMBUS };
