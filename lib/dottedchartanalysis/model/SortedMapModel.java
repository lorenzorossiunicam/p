...
public class SortedMapModel {
	...
	protected void updateMinMaxValue(String time, String instanceid, String task, String originator, String event,
			long value) {
	...
	public ArrayList<String> getSortedItemArrayList(String timeOption, String componentType, String sortStardard,
			boolean desc) {
		if (sortStardard.equals(DottedChartPanel.ST_START_TIME) || sortStardard.equals(DottedChartPanel.ST_END_TIME)
	...
	public HashMap<Integer, Integer> getSortedMapping(String timeOption, String str, String sort, boolean desc) {
		...
		if (sort.equals(DottedChartPanel.ST_START_TIME) || sort.equals(DottedChartPanel.ST_END_TIME)
