...
@Plugin(name = "Visualize HeuristicsNet with Annotations", level = PluginLevel.PeerReviewed, parameterLabels = { "HeuristicsNet" }, returnLabels = { "HN Annotated Visualization - No Semantics" }, returnTypes = { JComponent.class })
@Visualizer
